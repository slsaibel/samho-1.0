 ...
 * 
 */
public final class IFrmManTipoTelefone extends JInternalFrame {

    // Declaração de atributos
    private TiposTelefones tipoTelefone;

    // Construtor
    public IFrmManTipoTelefone(TiposTelefones tipoTelefone) throws Exception {
        initComponents();
        ...
        carregarObjetoIFrmManutencao(tipoTelefone);
    }

    public void carregarObjetoIFrmManutencao(TiposTelefones tipoTelefone) {
        try {
            if (tipoTelefone.getIdTipoTelefone() != -1) {
                txtCodigo.setText(String.valueOf(tipoTelefone.getIdTipoTelefone()));
            } else {
                txtCodigo.setText(String.valueOf(
                        tipoTelefone.getTipoTelefoneDAO().getProximoID()));
            }
            txtDescicao.setText(tipoTelefone.getDescricao());
            chkAtivo.setSelected(tipoTelefone.isAtivo());
        } catch (Exception ex) {
    ...
    private void reescreverObjeto() {
        try {
            tipoTelefone.setIdTipoTelefone(Long.parseUnsignedLong(
                    txtCodigo.getText()));
            tipoTelefone.setDescricao(txtDescicao.getText());
            tipoTelefone.setAtivo(chkAtivo.isSelected());
    ...
    private void initComponents() {
        ...
        setTitle("Cadastro de Tipo de Telefone");
        setMaximumSize(new java.awt.Dimension(730, 209));
        setMinimumSize(new java.awt.Dimension(730, 209));
        setName(""); // NOI18N
        setPreferredSize(new java.awt.Dimension(730, 209));
        ...
        pnlBotoes.setBounds(0, 120, 713, 38);
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        ...
        Util.salvar(tipoTelefone, this, true);
