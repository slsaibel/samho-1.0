 ...
 * 
 */
public class IFrmPesqEnderecos extends JInternalFrame {

    // Declaração de atributos
    private IFrmManEndereco iFrmManEndereco;
    ...
    // Construtor
    public IFrmPesqEnderecos(IFrmManEndereco iFrmManEndereco) throws Exception {
        inicializar(iFrmManEndereco);
    }

    public IFrmPesqEnderecos(IFrmManEndereco iFrmManEndereco,
    ...
    private void inicializar(IFrmManEndereco iFrmManEndereco) {
        initComponents();

        tbResultado.getTableHeader().setReorderingAllowed(false);
        this.iFrmManEndereco = iFrmManEndereco;
        endereco = iFrmManEndereco.getEndereco();
        dadosWhere = new ArrayList<>();
        dadosWhere.addAll(endereco.getObjetoDAO().getCondicaoWhere());

        Util.atualizar(endereco, tbResultado);
    ...
    private void efetuarPesquisa() {
        endereco.removerWhere();

        if (!txtCodigo.getText().equals("")) {
            Util.verificarPesquisarCampoID(endereco, txtCodigo);
        }

        if (!txtDescricao.getText().equals("")) {
            Util.verificarPesquisarCampoDescricao(endereco, txtDescricao);
        }
        
        if (chkAtivo.isSelected()) {
            Util.verificarPesquisarObjetoAtivo(endereco, chkAtivo);
        }

        endereco.adicionarWhere(dadosWhere);
    ...
    private void btnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIncluirActionPerformed
        try {
            iFrmManEndereco.carregarObjetoIFrmManutencao(new Enderecos());

            Util.incluir(this, iFrmManEndereco);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this.getParent(),
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        try {
            reescreverObjeto();
            iFrmManEndereco.carregarObjetoIFrmManutencao(endereco);

            JOptionPane.showMessageDialog(this.getParent(),
                    Util.alterar(this, iFrmManEndereco));
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        Util.excluir(endereco, tbResultado, this);
        ...
        if ((btnAlterar.isEnabled()) && (evt.getClickCount() == 2)) {
            try {
                ...
                if ((jTextFieldCodigo == null) && (jTextFieldDescricao == null)) {
                    ...
                    jTextFieldCodigo.setText(String.valueOf(endereco.getIdEndereco()));
