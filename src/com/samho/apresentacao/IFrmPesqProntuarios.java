 ...
 * 
 */
public class IFrmPesqProntuarios extends JInternalFrame {

    // Declaração de atributos
    private IFrmManProntuario iFrmManProntuario;
    ...
    // Construtor
    public IFrmPesqProntuarios(IFrmManProntuario iFrmManProntuario) throws Exception {
        inicializar(iFrmManProntuario);
    }

    public IFrmPesqProntuarios(IFrmManProntuario iFrmManProntuario,
    ...
    private void inicializar(IFrmManProntuario iFrmManProntuario) {
        initComponents();

        tbResultado.getTableHeader().setReorderingAllowed(false);
        this.iFrmManProntuario = iFrmManProntuario;
        prontuario = iFrmManProntuario.getProntuario();
        dadosWhere = new ArrayList<>();
        dadosWhere.addAll(prontuario.getObjetoDAO().getCondicaoWhere());

        Util.atualizar(prontuario, tbResultado);
    ...
    private void reescreverObjeto() {
        try {
            ...
            prontuario.setMotivoConsulta(tbResultado.getValueAt(
                    tbResultado.getSelectedRow(), 3).toString());
            prontuario.setDiagnostico(tbResultado.getValueAt(
            ...
            prontuario.setDataConsulta(
                    Formatacao.ajustaData(tbResultado.getValueAt(
                            ...
                            Formatacao.DATA_AMD));
            prontuario.setParecerProfissional(tbResultado.getValueAt(
                    tbResultado.getSelectedRow(), 6).toString());
            prontuario.setObservacoes(tbResultado.getValueAt(
    ...
    private void efetuarPesquisa() {
        prontuario.removerWhere();

        if (!txtCodigo.getText().equals("")) {
            Util.verificarPesquisarCampoID(prontuario, txtCodigo);
        }
        
        if (chkDevemRetornar.isSelected()) {
            Util.verificarPesquisarObjetoAtivo(
                    prontuario, "deve_retornar", chkDevemRetornar);
        }

        prontuario.adicionarWhere(dadosWhere);
    ...
    private void initComponents() {
        ...
        chkDevemRetornar = new javax.swing.JCheckBox();
        ...
        setMaximizable(true);
        setTitle("Consultar Prontuários");
        ...
        jLabel7.setText("Devem Retornar");

        chkDevemRetornar.setToolTipText("");
        chkDevemRetornar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                chkDevemRetornarActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(pnlBotoes, javax.swing.GroupLayout.DEFAULT_SIZE, 722, Short.MAX_VALUE)
        );
    ...
    private void btnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIncluirActionPerformed
        try {
            iFrmManProntuario.carregarObjetoIFrmManutencao(new Prontuarios());

            Util.incluir(this, iFrmManProntuario);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this.getParent(),
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        try {
            reescreverObjeto();
            iFrmManProntuario.carregarObjetoIFrmManutencao(prontuario);

            JOptionPane.showMessageDialog(this.getParent(),
                    Util.alterar(this, iFrmManProntuario));
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        Util.excluir(prontuario, tbResultado, this);
        ...
        if ((btnAlterar.isEnabled()) && (evt.getClickCount() == 2)) {
            try {
                ...
                if ((jTextFieldCodigo == null) && (jTextFieldDescricao == null)) {
                    ...
                    jTextFieldDescricao.setText(prontuario.getMotivoConsulta());
    ...
    private void chkDevemRetornarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkDevemRetornarActionPerformed
        efetuarPesquisa();
    }//GEN-LAST:event_chkDevemRetornarActionPerformed
    ...
    private javax.swing.JCheckBox chkDevemRetornar;
