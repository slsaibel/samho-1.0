 ...
 * 
 */
public class IFrmPesqProfissionaisTurnos extends JInternalFrame {

    // Declaração de atributos
    private IFrmManProfissionalTurnos iFrmManProfissionalTurnos;
    ...
    // Construtor
    public IFrmPesqProfissionaisTurnos(
            IFrmManProfissionalTurnos iFrmManProfissionalTurnos) 
            throws Exception {
        inicializar(iFrmManProfissionalTurnos);
    }
    ...
    private void inicializar(IFrmManProfissionalTurnos iFrmManProfissionalTurnos) {
        initComponents();

        tbResultado.getTableHeader().setReorderingAllowed(false);
        this.iFrmManProfissionalTurnos = iFrmManProfissionalTurnos;
        profissionalTurnos = iFrmManProfissionalTurnos.getProfissionalTurnos();
        dadosWhere = new ArrayList<>();
        dadosWhere.addAll(profissionalTurnos.getObjetoDAO().getCondicaoWhere());
    ...
    private void efetuarPesquisa() {
        profissionalTurnos.removerWhere();

        if (!txtCodigo.getText().equals("")) {
            Util.verificarPesquisarCampoID(profissionalTurnos, txtCodigo);
        }

        if (!txtDescricao.getText().equals("")) {
            Util.verificarPesquisarCampoDescricao(profissionalTurnos, txtDescricao);
        }

        profissionalTurnos.adicionarWhere(dadosWhere);
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setTitle("Consultar Profissionais por Turnos");
        ...
        jLabel1.setText("Cód. Prof. Turnos");
    ...
    private void btnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIncluirActionPerformed
        try {
            iFrmManProfissionalTurnos.carregarObjetoIFrmManutencao(
                    new ProfissionaisTurnos());

            Util.incluir(this, iFrmManProfissionalTurnos);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this.getParent(),
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        try {
            ...
            Util.alterar(this, iFrmManProfissionalTurnos);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this.getParent(),
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        Util.excluir(profissionalTurnos, tbResultado, this);
        ...
        if ((btnAlterar.isEnabled()) && (evt.getClickCount() == 2)) {
            try {
                ...
                if ((jTextFieldCodigo != null) && (jTextFieldDescricao != null)) {
                    ...
                    registrador = profissionalTurnos.getObjetoDAO().popularCodigoDescricao(
                            String.valueOf(profissionalTurnos.getIdProfissionalTurnos()),
                            profissionalTurnos.getProfissionalTurnosDAO().getSQLSubstiturCampoDescricao(
