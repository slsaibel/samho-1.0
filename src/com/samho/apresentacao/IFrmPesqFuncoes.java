 ...
 * 
 */
public class IFrmPesqFuncoes extends JInternalFrame {

    // Declaração de atributos
    private IFrmManFuncao iFrmManFuncao;
    ...
    // Construtor
    public IFrmPesqFuncoes(IFrmManFuncao iFrmManFuncao)
            throws Exception {
        inicializar(iFrmManFuncao);
    }
    ...
    private void inicializar(IFrmManFuncao iFrmManFuncao) {
        initComponents();

        tbResultado.getTableHeader().setReorderingAllowed(false);
        this.iFrmManFuncao = iFrmManFuncao;
        funcao = iFrmManFuncao.getFuncao();
        dadosWhere = new ArrayList<>();
        dadosWhere.addAll(funcao.getObjetoDAO().getCondicaoWhere());

        Util.atualizar(funcao, tbResultado);
    ...
    private void efetuarPesquisa() {
        ...
        if (!txtCodigo.getText().equals("")) {
            Util.verificarPesquisarCampoID(funcao, txtCodigo);
        }

        if (!txtDescricao.getText().equals("")) {
            Util.verificarPesquisarCampoDescricao(funcao, txtDescricao);
        }
        
        if (chkAtivo.isSelected()) {
            Util.verificarPesquisarObjetoAtivo(funcao, chkAtivo);
        }

        funcao.adicionarWhere(dadosWhere);
    ...
    private void btnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIncluirActionPerformed
        try {
            iFrmManFuncao.carregarObjetoIFrmManutencao(
                    new Funcoes());

            Util.incluir(this, iFrmManFuncao);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this.getParent(),
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        try {
            reescreverObjeto();
            iFrmManFuncao.carregarObjetoIFrmManutencao(funcao);

            Util.alterar(this, iFrmManFuncao);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this.getParent(),
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        Util.excluir(funcao, tbResultado, this);
        ...
        if ((btnAlterar.isEnabled()) && (evt.getClickCount() == 2)) {
            try {
                ...
                if ((jTextFieldCodigo == null) && (jTextFieldDescricao == null)) {
                    ...
                    jTextFieldCodigo.setText(String.valueOf(funcao.getIdFuncao()));
                    jTextFieldDescricao.setText(funcao.getDescricao());
