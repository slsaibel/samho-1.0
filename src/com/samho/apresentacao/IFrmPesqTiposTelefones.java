 ...
 * 
 */
public class IFrmPesqTiposTelefones extends JInternalFrame {

    // Declaração de atributos
    private IFrmManTipoTelefone iFrmManTipoTelefone;
    ...
    // Construtor
    public IFrmPesqTiposTelefones(IFrmManTipoTelefone iFrmManTipoTelefone)
            throws Exception {
        inicializar(iFrmManTipoTelefone);
    }
    ...
    private void inicializar(IFrmManTipoTelefone iFrmManTipoTelefone) {
        initComponents();

        tbResultado.getTableHeader().setReorderingAllowed(false);
        this.iFrmManTipoTelefone = iFrmManTipoTelefone;
        tipoTelefone = iFrmManTipoTelefone.getTipoTelefone();
        dadosWhere = new ArrayList<>();
        dadosWhere.addAll(tipoTelefone.getObjetoDAO().getCondicaoWhere());

        Util.atualizar(tipoTelefone, tbResultado);
    ...
    private void reescreverObjeto() {
        try {
            tipoTelefone.setIdTipoTelefone(Long.parseUnsignedLong(
                    tbResultado.getValueAt(
                            tbResultado.getSelectedRow(), 0).toString()));
            tipoTelefone.setDescricao(tbResultado.getValueAt(
                    tbResultado.getSelectedRow(), 1).toString());
            tipoTelefone.setAtivo(false);

            tipoTelefone.adicionarCampos();
    ...
    private void efetuarPesquisa() {
        tipoTelefone.removerWhere();

        if (!txtCodigo.getText().equals("")) {
            Util.verificarPesquisarCampoID(tipoTelefone, txtCodigo);
        }

        if (!txtDescricao.getText().equals("")) {
            Util.verificarPesquisarCampoDescricao(tipoTelefone, txtDescricao);
        }
        
        if (chkAtivo.isSelected()) {
            Util.verificarPesquisarObjetoAtivo(tipoTelefone, chkAtivo);
        }

        tipoTelefone.adicionarWhere(dadosWhere);
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setTitle("Consultar Tipos de Telefones");
        ...
        pnlConteudosLayout.setVerticalGroup(
            ...
            .addGroup(pnlConteudosLayout.createSequentialGroup()
                .addComponent(pnlPesquisarCampos, javax.swing.GroupLayout.PREFERRED_SIZE, 83, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(pnlBotoes, javax.swing.GroupLayout.DEFAULT_SIZE, 724, Short.MAX_VALUE)
        );
    ...
    private void btnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIncluirActionPerformed
        try {
            iFrmManTipoTelefone.carregarObjetoIFrmManutencao(
                    new TiposTelefones());

            Util.incluir(this, iFrmManTipoTelefone);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this.getParent(),
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        try {
            reescreverObjeto();
            iFrmManTipoTelefone.carregarObjetoIFrmManutencao(tipoTelefone);

            Util.alterar(this, iFrmManTipoTelefone);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this.getParent(),
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        Util.excluir(tipoTelefone, tbResultado, this);
        ...
        if ((btnAlterar.isEnabled()) && (evt.getClickCount() == 2)) {
            try {
                ...
                if ((jTextFieldCodigo == null) && (jTextFieldDescricao == null)) {
                    ...
                    jTextFieldCodigo.setText(String.valueOf(tipoTelefone.getIdTipoTelefone()));
                    jTextFieldDescricao.setText(tipoTelefone.getDescricao());
