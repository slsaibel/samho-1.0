 ...
 * 
 */
public final class IFrmManFuncao extends JInternalFrame {

    // Declaração de atributos
    private Funcoes funcao;

    // Construtor
    public IFrmManFuncao(Funcoes funcao) throws Exception {
        initComponents();
        ...
        carregarObjetoIFrmManutencao(funcao);
    }

    public void carregarObjetoIFrmManutencao(Funcoes funcao) {
        try {
            if (funcao.getIdFuncao()!= -1) {
                txtCodigo.setText(String.valueOf(funcao.getIdFuncao()));
            } else {
                txtCodigo.setText(String.valueOf(
                        funcao.getFuncaoDAO().getProximoID()));
            }
            txtDescicao.setText(funcao.getDescricao());
            chkAtivo.setSelected(funcao.isAtivo());
        } catch (Exception ex) {
    ...
    private void reescreverObjeto() {
        try {
            funcao.setIdFuncao(Long.parseUnsignedLong(txtCodigo.getText()));
            funcao.setDescricao(txtDescicao.getText());
            funcao.setAtivo(chkAtivo.isSelected());
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(730, 220));
        setMinimumSize(new java.awt.Dimension(730, 220));
        setName(""); // NOI18N
        setPreferredSize(new java.awt.Dimension(730, 220));
        ...
        pnlBotoes.setBounds(0, 130, 713, 38);
