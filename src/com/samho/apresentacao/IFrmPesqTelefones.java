 ...
 * 
 */
public class IFrmPesqTelefones extends JInternalFrame {

    // Declaração de atributos
    private IFrmManTelefone iFrmManTelefone;
    ...
    // Construtor
    public IFrmPesqTelefones(IFrmManTelefone iFrmManTelefone) throws Exception {
        inicializar(iFrmManTelefone);
    }

    public IFrmPesqTelefones(IFrmManTelefone iFrmManTelefone,
    ...
    private void inicializar(IFrmManTelefone iFrmManTelefone) {
        initComponents();

        tbResultado.getTableHeader().setReorderingAllowed(false);
        this.iFrmManTelefone = iFrmManTelefone;
        telefone = iFrmManTelefone.getTelefone();
        dadosWhere = new ArrayList<>();
        dadosWhere.addAll(telefone.getObjetoDAO().getCondicaoWhere());

        Util.atualizar(telefone, tbResultado);
    ...
    private void reescreverObjeto() {
        try {
            ...
            telefone.setContato(tbResultado.getValueAt(
    ...
    private void efetuarPesquisa() {
        telefone.removerWhere();

        if (!txtCodigo.getText().equals("")) {
            Util.verificarPesquisarCampoID(telefone, txtCodigo);
        }

        if (!txtDescricao.getText().equals("")) {
            Util.verificarPesquisarCampoDescricao(telefone, txtDescricao);
        }
        
        if (chkAtivo.isSelected()) {
            Util.verificarPesquisarObjetoAtivo(telefone, chkAtivo);
        }

        telefone.adicionarWhere(dadosWhere);
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(pnlBotoes, javax.swing.GroupLayout.DEFAULT_SIZE, 714, Short.MAX_VALUE)
        );
    ...
    private void btnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIncluirActionPerformed
        try {
            iFrmManTelefone.carregarObjetoIFrmManutencao(new Telefones());

            Util.incluir(this, iFrmManTelefone);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this.getParent(),
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        try {
            reescreverObjeto();
            iFrmManTelefone.carregarObjetoIFrmManutencao(telefone);

            Util.alterar(this, iFrmManTelefone);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this.getParent(),
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        Util.excluir(telefone, tbResultado, this);
        ...
        if ((btnAlterar.isEnabled()) && (evt.getClickCount() == 2)) {
            try {
                ...
                if ((jTextFieldCodigo == null) && (jTextFieldDescricao == null)) {
                    ...
                    jTextFieldCodigo.setText(String.valueOf(telefone.getIdTelefone()));
                    jTextFieldDescricao.setText(telefone.getDadosDescricao().getValor());
