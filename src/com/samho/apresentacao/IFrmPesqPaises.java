 ...
 * 
 */
public class IFrmPesqPaises extends JInternalFrame {

    // Declaração de atributos
    private IFrmManPais iFrmManPais;
    private Paises pais;
    ...
    // Construtor
    public IFrmPesqPaises(IFrmManPais iFrmManPais) throws Exception {
        inicializar(iFrmManPais);
    }

    public IFrmPesqPaises(IFrmManPais iFrmManPais, JTextField jTextFieldCodigo,
    ...
    private void inicializar(IFrmManPais iFrmManPais) {
        initComponents();

        this.iFrmManPais = iFrmManPais;
        pais = iFrmManPais.getPais();
        dadosWhere = new ArrayList<>();
        dadosWhere.addAll(pais.getObjetoDAO().getCondicaoWhere());

        Util.atualizar(pais, tbResultado);
    ...
    public void verificarPermissoes (){
        boolean[] acoes = Util.getAcoesUsuario(Principal.PAISES);
    ...
    private void reescreverObjeto() {
        try {
            pais.setIdPais(Long.parseUnsignedLong(tbResultado.getValueAt(
                    tbResultado.getSelectedRow(), 0).toString()));
            pais.setCodigoIBGE(Integer.parseInt(tbResultado.getValueAt(
                    tbResultado.getSelectedRow(), 1).toString()));
            pais.setSigla(tbResultado.getValueAt(
                    tbResultado.getSelectedRow(), 2).toString());
            pais.setDescricao(tbResultado.getValueAt(
    ...
    private void efetuarPesquisa() {
        ...
        if (!txtCodigo.getText().equals("")) {
            Util.verificarPesquisarCampoID(pais, txtCodigo);
        }

        if (!txtDescricao.getText().equals("")) {
            Util.verificarPesquisarCampoDescricao(pais, txtDescricao);
        }

        pais.adicionarWhere(dadosWhere);
    ...
    private void btnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIncluirActionPerformed
        try {
            iFrmManPais.carregarObjetoIFrmManutencao(new Paises());

            Util.incluir(this, iFrmManPais);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this.getParent(),
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        try {
            reescreverObjeto();
            iFrmManPais.carregarObjetoIFrmManutencao(pais);

            Util.alterar(this, iFrmManPais);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this.getParent(),
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        Util.excluir(pais, tbResultado, this);
        ...
        if ((btnAlterar.isEnabled()) && (evt.getClickCount() == 2)) {
            try {
                ...
                if ((jTextFieldCodigo == null) && (jTextFieldDescricao == null)) {
                    ...
                    jTextFieldCodigo.setText(String.valueOf(pais.getIdPais()));
                    jTextFieldDescricao.setText(pais.getDescricao());
