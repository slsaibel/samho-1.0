 ...
 * 
 */
public class IFrmPesqSituacoesPessoas extends JInternalFrame {

    // Declaração de atributos
    private IFrmManSituacaoPessoas iFrmManSituacao;
    private SituacoesPessoas situacao;
    private JTextField jTextFieldCodigo;
    private JTextField jTextFieldDescricao;
    private ArrayList<DadosDAO> dadosWhere;

    // Construtor
    public IFrmPesqSituacoesPessoas(IFrmManSituacaoPessoas iFrmManSituacao) throws Exception {
        inicializar(iFrmManSituacao);
    }

    public IFrmPesqSituacoesPessoas(IFrmManSituacaoPessoas iFrmManSituacao,
    ...
    private void inicializar(IFrmManSituacaoPessoas iFrmManSituacao) {
        initComponents();
    ...
    public void verificarPermissoes (){
        boolean[] acoes = Util.getAcoesUsuario(Principal.SITUACOES_PESSOAS);
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setTitle("Consultar Situações de Pessoas");
    ...
    private void btnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIncluirActionPerformed
        try {
            iFrmManSituacao.carregarObjetoIFrmManutencao(new SituacoesPessoas());
     ...
     * @return the situacao
     */
    public SituacoesPessoas getSituacao() {
        return situacao;
    }
     ...
     */
    public void setSituacao(SituacoesPessoas situacao) {
