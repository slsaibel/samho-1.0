 ...
 * 
 */
public class IFrmPesqTiposEnderecos extends JInternalFrame {

    // Declaração de atributos
    private IFrmManTipoEndereco iFrmManTipoEndereco;
    ...
    // Construtor
    public IFrmPesqTiposEnderecos(IFrmManTipoEndereco iFrmManTipoEndereco)
            throws Exception {
        inicializar(iFrmManTipoEndereco);
    }
    ...
    private void inicializar(IFrmManTipoEndereco iFrmManTipoEndereco) {
        initComponents();

        tbResultado.getTableHeader().setReorderingAllowed(false);
        this.iFrmManTipoEndereco = iFrmManTipoEndereco;
        tipoEndereco = iFrmManTipoEndereco.getTipoEndereco();
        dadosWhere = new ArrayList<>();
        dadosWhere.addAll(tipoEndereco.getObjetoDAO().getCondicaoWhere());

        Util.atualizar(tipoEndereco, tbResultado);
    ...
    private void reescreverObjeto() {
        try {
            tipoEndereco.setIdTipoEndereco(Long.parseUnsignedLong(
                    tbResultado.getValueAt(
                            tbResultado.getSelectedRow(), 0).toString()));
            tipoEndereco.setDescricao(tbResultado.getValueAt(
                    tbResultado.getSelectedRow(), 1).toString());
            tipoEndereco.setAtivo(false);

            tipoEndereco.adicionarCampos();
    ...
    private void efetuarPesquisa() {
        tipoEndereco.removerWhere();

        if (!txtCodigo.getText().equals("")) {
            Util.verificarPesquisarCampoID(tipoEndereco, txtCodigo);
        }

        if (!txtDescricao.getText().equals("")) {
            Util.verificarPesquisarCampoDescricao(tipoEndereco, txtDescricao);
        }
        
        if (chkAtivo.isSelected()) {
            Util.verificarPesquisarObjetoAtivo(tipoEndereco, chkAtivo);
        }

        tipoEndereco.adicionarWhere(dadosWhere);
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setTitle("Consultar Tipos de Endereços");
        ...
        jLabel1.setText("Cód. Tipo Ender.");
        ...
        pnlConteudosLayout.setVerticalGroup(
            ...
            .addGroup(pnlConteudosLayout.createSequentialGroup()
                .addComponent(pnlPesquisarCampos, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(pnlBotoes, javax.swing.GroupLayout.DEFAULT_SIZE, 728, Short.MAX_VALUE)
        );
    ...
    private void btnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIncluirActionPerformed
        try {
            iFrmManTipoEndereco.carregarObjetoIFrmManutencao(
                    new TiposEnderecos());

            Util.incluir(this, iFrmManTipoEndereco);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this.getParent(),
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        try {
            reescreverObjeto();
            iFrmManTipoEndereco.carregarObjetoIFrmManutencao(tipoEndereco);

            Util.alterar(this, iFrmManTipoEndereco);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this.getParent(),
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        Util.excluir(tipoEndereco, tbResultado, this);
        ...
        if ((btnAlterar.isEnabled()) && (evt.getClickCount() == 2)) {
            try {
                ...
                if ((jTextFieldCodigo == null) && (jTextFieldDescricao == null)) {
                    ...
                    jTextFieldCodigo.setText(String.valueOf(tipoEndereco.getIdTipoEndereco()));
                    jTextFieldDescricao.setText(tipoEndereco.getDescricao());
