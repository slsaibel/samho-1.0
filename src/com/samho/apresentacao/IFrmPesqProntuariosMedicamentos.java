 ...
 */
public class IFrmPesqProntuariosMedicamentos extends JInternalFrame {

    // Declaração de atributos
    private IFrmManProntuarioMedicamento iFrmManProntuarioMedicamento;
    ...
    // Construtor
    public IFrmPesqProntuariosMedicamentos(
            IFrmManProntuarioMedicamento iFrmManProntuarioMedicamento)
            throws Exception {
        inicializar(iFrmManProntuarioMedicamento);
    }
    ...
    private void inicializar(
        ...
        this.iFrmManProntuarioMedicamento = iFrmManProntuarioMedicamento;
        prontuarioMedicamento = 
                iFrmManProntuarioMedicamento.getProntuarioMedicamento();
        dadosWhere = new ArrayList<>();
        dadosWhere.addAll(prontuarioMedicamento.getObjetoDAO().getCondicaoWhere());

        Util.atualizar(prontuarioMedicamento, tbResultado);
    ...
    public void verificarPermissoes (){
        boolean[] acoes = Util.getAcoesUsuario(
                Principal.PRONTUARIOS_MEDICAMENTOS);
    ...
    private void reescreverObjeto() {
        try {
            ...
            prontuarioMedicamento.setParecerProfissional(tbResultado.getValueAt(
    ...
    private void efetuarPesquisa() {
        prontuarioMedicamento.removerWhere();

        if (!txtCodigo.getText().equals("")) {
            Util.verificarPesquisarCampoID(prontuarioMedicamento, txtCodigo);
        }

        if (!txtDescricao.getText().equals("")) {
            Util.verificarPesquisarCampoDescricao(prontuarioMedicamento, 
                    txtDescricao);
        }
        
        prontuarioMedicamento.adicionarWhere(dadosWhere);
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setTitle("Consultar Prontuários Medicamentos");
        setToolTipText("");
    ...
    private void btnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIncluirActionPerformed
        try {
            iFrmManProntuarioMedicamento.carregarObjetoIFrmManutencao(
                    new ProntuariosMedicamentos());

            Util.incluir(this, iFrmManProntuarioMedicamento);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this.getParent(),
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        try {
            ...
            JOptionPane.showMessageDialog(this.getParent(),
                    Util.alterar(this, iFrmManProntuarioMedicamento));
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        Util.excluir(prontuarioMedicamento, tbResultado, this);
        ...
        if ((btnAlterar.isEnabled()) && (evt.getClickCount() == 2)) {
            try {
                ...
                if ((jTextFieldCodigo != null) && (jTextFieldDescricao != null)) {
                    ...
                    registrador = prontuarioMedicamento.getObjetoDAO().popularCodigoDescricao(
                            String.valueOf(prontuarioMedicamento.getIdProntuarioMedicamento()),
                            prontuarioMedicamento.getProntuarioMedicamentoDAO().getSQLSubstiturCampoDescricao(
