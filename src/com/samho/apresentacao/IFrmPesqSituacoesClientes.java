 ...
 * 
 */
public class IFrmPesqSituacoesClientes extends JInternalFrame {

    // Declaração de atributos
    private IFrmManSituacaoClientes iFrmManSituacao;
    ...
    // Construtor
    public IFrmPesqSituacoesClientes(IFrmManSituacaoClientes iFrmManSituacao) throws Exception {
        inicializar(iFrmManSituacao);
    }

    public IFrmPesqSituacoesClientes(IFrmManSituacaoClientes iFrmManSituacao,
    ...
    private void inicializar(IFrmManSituacaoClientes iFrmManSituacao) {
        initComponents();
    ...
    public void verificarPermissoes (){
        boolean[] acoes = Util.getAcoesUsuario(Principal.SITUACOES_CLIENTES);
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setTitle("Consultar Situações de Clientes");
    ...
    private void btnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIncluirActionPerformed
        try {
            iFrmManSituacao.carregarObjetoIFrmManutencao(new SituacoesClientes());
