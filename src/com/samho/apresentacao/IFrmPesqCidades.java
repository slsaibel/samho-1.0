 ...
 * 
 */
public class IFrmPesqCidades extends JInternalFrame {

    // Declaração de atributos
    private IFrmManCidade iFrmManCidade;
    ...
    // Construtor
    public IFrmPesqCidades(IFrmManCidade iFrmManCidade) throws Exception {
        inicializar(iFrmManCidade);
    }

    public IFrmPesqCidades(IFrmManCidade iFrmManCidade,
    ...
    private void inicializar(IFrmManCidade iFrmManCidade) {
        initComponents();

        this.iFrmManCidade = iFrmManCidade;
        cidade = iFrmManCidade.getCidade();
        dadosWhere = new ArrayList<>();
        dadosWhere.addAll(cidade.getObjetoDAO().getCondicaoWhere());

        Util.atualizar(cidade, tbResultado);
    ...
    private void efetuarPesquisa() {
        ...
        if (!txtCodigo.getText().equals("")) {
            Util.verificarPesquisarCampoID(cidade, txtCodigo);
        }

        if (!txtDescricao.getText().equals("")) {
            Util.verificarPesquisarCampoDescricao(cidade, txtDescricao);
        }

        cidade.adicionarWhere(dadosWhere);
    ...
    private void btnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIncluirActionPerformed
        try {
            iFrmManCidade.carregarObjetoIFrmManutencao(new Cidades());

            Util.incluir(this, iFrmManCidade);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this.getParent(),
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        try {
            reescreverObjeto();
            iFrmManCidade.carregarObjetoIFrmManutencao(cidade);

            Util.alterar(this, iFrmManCidade);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this.getParent(),
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        Util.excluir(cidade, tbResultado, this);
        ...
        if ((btnAlterar.isEnabled()) && (evt.getClickCount() == 2)) {
            try {
                ...
                if ((jTextFieldCodigo == null) && (jTextFieldDescricao == null)) {
                    ...
                    jTextFieldCodigo.setText(String.valueOf(cidade.getIdCidade()));
                    jTextFieldDescricao.setText(cidade.getDescricao());
