 ...
 */
public class IFrmPesqProntuariosSintomasApresentados extends JInternalFrame {
    ...
    // Construtor
    public IFrmPesqProntuariosSintomasApresentados(
    ...
    public void verificarPermissoes (){
        boolean[] acoes = Util.getAcoesUsuario(
                Principal.PRONTUARIOS_SINTOMAS_APRESENTADOS);
