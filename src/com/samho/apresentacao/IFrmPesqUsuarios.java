 ...
 *
 * @version  revision 001.20170405 date 05/04/2017 author Saibel, Sérgio Luis reason
 ...
 * 
 */
public class IFrmPesqUsuarios extends JInternalFrame {

    // Declaração de atributos
    private IFrmManUsuario iFrmManUsuario;
    ...
    // Construtor
    public IFrmPesqUsuarios(IFrmManUsuario iFrmManUsuario) throws Exception {
        inicializar(iFrmManUsuario);
    }

    public IFrmPesqUsuarios(IFrmManUsuario iFrmManUsuario,
    ...
    private void inicializar(IFrmManUsuario iFrmManUsuario) {
        initComponents();

        tbResultado.getTableHeader().setReorderingAllowed(false);
        this.iFrmManUsuario = iFrmManUsuario;
        usuario = iFrmManUsuario.getUsuario();
        dadosWhere = new ArrayList<>();
        dadosWhere.addAll(usuario.getObjetoDAO().getCondicaoWhere());

        Util.atualizar(usuario, tbResultado);
    ...
    private void reescreverObjeto() {
        try {
            usuario.setIdUsuario(Long.parseUnsignedLong(tbResultado.getValueAt(
            ...
            usuario.setLogin(tbResultado.getValueAt(
                    tbResultado.getSelectedRow(), 3).toString());
            usuario.setSenha(tbResultado.getValueAt(
    ...
    private void efetuarPesquisa() {
        usuario.removerWhere();

        if (!txtCodigo.getText().equals("")) {
            Util.verificarPesquisarCampoID(usuario, txtCodigo);
        }

        if (!txtDescricao.getText().equals("")) {
            Util.verificarPesquisarCampoDescricao(usuario, txtDescricao);
        }

        usuario.adicionarWhere(dadosWhere);
    ...
    private void btnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIncluirActionPerformed
        try {
            iFrmManUsuario.carregarObjetoIFrmManutencao(new Usuarios());

            Util.incluir(this, iFrmManUsuario);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this.getParent(),
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        try {
            reescreverObjeto();
            iFrmManUsuario.carregarObjetoIFrmManutencao(usuario);

            JOptionPane.showMessageDialog(this.getParent(),
                    Util.alterar(this, iFrmManUsuario));
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        Util.excluir(usuario, tbResultado, this);
        ...
        if ((btnAlterar.isEnabled()) && (evt.getClickCount() == 2)) {
            try {
                ...
                if ((jTextFieldCodigo == null) && (jTextFieldDescricao == null)) {
                    ...
                    jTextFieldCodigo.setText(String.valueOf(usuario.getIdUsuario()));
                    jTextFieldDescricao.setText(usuario.getLogin());
