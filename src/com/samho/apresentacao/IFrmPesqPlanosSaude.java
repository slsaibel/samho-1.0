 ...
 * 
 */
public class IFrmPesqPlanosSaude extends JInternalFrame {

    // Declaração de atributos
    private IFrmManPlanoSaude iFrmManPlanoSaude;
    private PlanosSaude planoSaude;
    private JTextField jTextFieldCodigo;
    private JTextField jTextFieldDescricao;
    private ArrayList<DadosDAO> dadosWhere;

    // Construtor
    public IFrmPesqPlanosSaude(IFrmManPlanoSaude iFrmManPlanoSaude) throws Exception {
        inicializar(iFrmManPlanoSaude);
    }

    public IFrmPesqPlanosSaude(IFrmManPlanoSaude iFrmManPlanoSaude,
    ...
    private void inicializar(IFrmManPlanoSaude iFrmManPlanoSaude) {
        initComponents();

        tbResultado.getTableHeader().setReorderingAllowed(false);
        this.iFrmManPlanoSaude = iFrmManPlanoSaude;
        planoSaude = iFrmManPlanoSaude.getPlanoSaude();
        dadosWhere = new ArrayList<>();
        dadosWhere.addAll(planoSaude.getObjetoDAO().getCondicaoWhere());

        Util.atualizar(planoSaude, tbResultado);
    ...
    private void efetuarPesquisa() {
        planoSaude.removerWhere();

        if (!txtCodigo.getText().equals("")) {
            Util.verificarPesquisarCampoID(planoSaude, txtCodigo);
        }

        if (!txtDescricao.getText().equals("")) {
            Util.verificarPesquisarCampoDescricao(planoSaude, txtDescricao);
        }
        
        if (chkAtivo.isSelected()) {
            Util.verificarPesquisarObjetoAtivo(planoSaude, chkAtivo);
        }

        planoSaude.adicionarWhere(dadosWhere);
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setTitle("Consultar Planos de Saúde");
    ...
    private void btnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIncluirActionPerformed
        try {
            iFrmManPlanoSaude.carregarObjetoIFrmManutencao(new PlanosSaude());

            Util.incluir(this, iFrmManPlanoSaude);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this.getParent(),
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        try {
            reescreverObjeto();
            iFrmManPlanoSaude.carregarObjetoIFrmManutencao(planoSaude);

            Util.alterar(this, iFrmManPlanoSaude);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this.getParent(),
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        Util.excluir(planoSaude, tbResultado, this);
        ...
        if ((btnAlterar.isEnabled()) && (evt.getClickCount() == 2)) {
            try {
                ...
                if ((jTextFieldCodigo == null) && (jTextFieldDescricao == null)) {
                    ...
                    jTextFieldDescricao.setText(planoSaude.getDescricao());
     ...
     */
    public PlanosSaude getPlanoSaude() {
        return planoSaude;
    }
     ...
     */
    public void setPlanoSaude(PlanosSaude planoSaude) {
