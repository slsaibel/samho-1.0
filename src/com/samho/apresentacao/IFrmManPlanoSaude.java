 ...
 * 
 */
public final class IFrmManPlanoSaude extends JInternalFrame {

    // Declaração de atributos
    private PlanosSaude planoSaude;

    // Construtor
    public IFrmManPlanoSaude(PlanosSaude planoSaude) throws Exception {
        initComponents();
        ...
        carregarObjetoIFrmManutencao(planoSaude);
    }

    public void carregarObjetoIFrmManutencao(PlanosSaude planoSaude) {
        try {
            if (planoSaude.getIdPlanoSaude() != -1) {
                txtCodigo.setText(String.valueOf(planoSaude.getIdPlanoSaude()));
            } else {
                txtCodigo.setText(String.valueOf(
                        planoSaude.getPlanoSaudeDAO().getProximoID()));
            }
            txtDescicao.setText(planoSaude.getDescricao());
            txtObservacoes.setText(planoSaude.getObservacoes());
            chkAtivo.setSelected(planoSaude.isAtivo());
        } catch (Exception ex) {
    ...
    private void reescreverObjeto() {
        try {
            planoSaude.setIdPlanoSaude(Long.parseUnsignedLong(
                    txtCodigo.getText()));
            planoSaude.setDescricao(txtDescicao.getText());
            planoSaude.setObservacoes(txtObservacoes.getText());
            planoSaude.setAtivo(chkAtivo.isSelected());
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        ...
        Util.salvar(planoSaude, this, true);
