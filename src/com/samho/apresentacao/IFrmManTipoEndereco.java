 ...
 * 
 */
public final class IFrmManTipoEndereco extends JInternalFrame {

    // Declaração de atributos
    private TiposEnderecos tipoEndereco;

    // Construtor
    public IFrmManTipoEndereco(TiposEnderecos tipoEndereco) throws Exception {
        initComponents();
        ...
        carregarObjetoIFrmManutencao(tipoEndereco);
    }

    public void carregarObjetoIFrmManutencao(TiposEnderecos tipoEndereco) {
        try {
            if (tipoEndereco.getIdTipoEndereco() != -1) {
                txtCodigo.setText(String.valueOf(tipoEndereco.getIdTipoEndereco()));
            } else {
                txtCodigo.setText(String.valueOf(
                        tipoEndereco.getTipoEnderecoDAO().getProximoID()));
            }
            txtDescicao.setText(tipoEndereco.getDescricao());
            chkAtivo.setSelected(tipoEndereco.isAtivo());
        } catch (Exception ex) {
    ...
    private void reescreverObjeto() {
        try {
            tipoEndereco.setIdTipoEndereco(Long.parseUnsignedLong(
                    txtCodigo.getText()));
            tipoEndereco.setDescricao(txtDescicao.getText());
            tipoEndereco.setAtivo(chkAtivo.isSelected());

            getTipoEndereco().adicionarCampos();
    ...
    private void initComponents() {
        ...
        setTitle("Cadastro de Tipo de Endereço");
        setMaximumSize(new java.awt.Dimension(730, 223));
        setMinimumSize(new java.awt.Dimension(730, 223));
        setName(""); // NOI18N
        setPreferredSize(new java.awt.Dimension(730, 223));
        ...
        pnlBotoes.setBounds(0, 133, 713, 38);
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        ...
        Util.salvar(tipoEndereco, this, true);
