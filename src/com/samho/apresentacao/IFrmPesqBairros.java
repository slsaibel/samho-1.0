 ...
 * 
 */
public class IFrmPesqBairros extends JInternalFrame {

    // Declaração de atributos
    private IFrmManBairro iFrmManBairro;
    ...
    // Construtor
    public IFrmPesqBairros(IFrmManBairro iFrmManBairro) throws Exception {
        inicializar(iFrmManBairro);
    }

    public IFrmPesqBairros(IFrmManBairro iFrmManBairro,
    ...
    private void inicializar(IFrmManBairro iFrmManBairro) {
        initComponents();

        // Permite que somente números sejam informados neste campo
        txtCodigo.setDocument(new JTextFieldDocument(true));

        this.iFrmManBairro = iFrmManBairro;

        bairro = iFrmManBairro.getBairro();

        dadosWhere = new ArrayList<>();
        dadosWhere.addAll(bairro.getObjetoDAO().getCondicaoWhere());

        Util.atualizar(bairro, tbResultado);
    ...
    private void reescreverObjeto() {
        try {
            bairro.setIdBairro(Long.parseUnsignedLong(tbResultado.getValueAt(
                    tbResultado.getSelectedRow(), 0).toString()));
            bairro.setCodCidade(Long.parseUnsignedLong(tbResultado.getValueAt(
                    tbResultado.getSelectedRow(), 1).toString()));
            // Reserva-se a próxima posição para a descrição do campo acima.
            bairro.setDescricao(tbResultado.getValueAt(
    ...
    private void efetuarPesquisa() {
        ...
        if (!txtCodigo.getText().equals("")) {
            Util.verificarPesquisarCampoID(bairro, txtCodigo);
        }

        if (!txtDescricao.getText().equals("")) {
            Util.verificarPesquisarCampoDescricao(bairro, txtDescricao);
        }

        bairro.adicionarWhere(dadosWhere);
    ...
    private void btnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIncluirActionPerformed
        try {
            iFrmManBairro.carregarObjetoIFrmManutencao(new Bairros());

            Util.incluir(this, iFrmManBairro);
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        try {
            ...
            iFrmManBairro.carregarObjetoIFrmManutencao(bairro);

            Util.alterar(this, iFrmManBairro);
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        Util.excluir(bairro, tbResultado, this);
    ...
    private void tbResultadoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbResultadoMouseClicked
        if ((btnAlterar.isEnabled()) && (evt.getClickCount() == 2)) {         try {
                ...
                if ((jTextFieldCodigo == null) && (jTextFieldDescricao == null)) {
                    ...
                    jTextFieldCodigo.setText(String.valueOf(bairro.getIdBairro()));
                    jTextFieldDescricao.setText(bairro.getDescricao());
