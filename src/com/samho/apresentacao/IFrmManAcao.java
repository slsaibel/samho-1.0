 ...
 * 
 */
public final class IFrmManAcao extends JInternalFrame {

    // Declaração de atributos
    private Acoes acao;

    // Construtor
    public IFrmManAcao(Acoes acao) throws Exception {
        initComponents();
        ...
        carregarObjetoIFrmManutencao(acao);
    }

    public void carregarObjetoIFrmManutencao(Acoes acao) {
        try {
            if (acao.getIdAcao()!= -1) {
                txtCodigo.setText(String.valueOf(acao.getIdAcao()));
            } else {
                txtCodigo.setText(String.valueOf(
                        acao.getAcaoDAO().getProximoID()));
            }
            txtDescicao.setText(acao.getDescricao());
        } catch (Exception ex) {
    ...
    private void reescreverObjeto() {
        try {
            acao.setIdAcao(Long.valueOf(txtCodigo.getText()));
            acao.setDescricao(txtDescicao.getText());
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(730, 189));
        setMinimumSize(new java.awt.Dimension(730, 189));
        setName(""); // NOI18N
        setPreferredSize(new java.awt.Dimension(730, 189));
        ...
        pnlBotoes.setBounds(0, 100, 713, 38);
