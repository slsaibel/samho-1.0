 ...
 * 
 */
public final class IFrmManMotivoAgenda extends JInternalFrame {

    // Declaração de atributos
    private MotivosAgendas motivoAgenda;

    // Construtor
    public IFrmManMotivoAgenda(MotivosAgendas motivoAgenda) throws Exception {
        initComponents();
        ...
        carregarObjetoIFrmManutencao(motivoAgenda);
    }

    public void carregarObjetoIFrmManutencao(MotivosAgendas motivoAgenda) {
        try {
            if (motivoAgenda.getIdMotivoAgenda()!= -1) {
                txtCodigo.setText(String.valueOf(
                        motivoAgenda.getIdMotivoAgenda()));
            } else {
                txtCodigo.setText(String.valueOf(
                        motivoAgenda.getMotivoAgendaDAO().getProximoID()));
            }
            
            txtDescicao.setText(motivoAgenda.getDescricao());
            txtObservacoes.setText(motivoAgenda.getObservacoes());
            chkAtivo.setSelected(motivoAgenda.isAtivo());
        } catch (Exception ex) {
    ...
    private void reescreverObjeto() {
        try {
            motivoAgenda.setIdMotivoAgenda(Long.parseUnsignedLong(
                    txtCodigo.getText()));
            motivoAgenda.setDescricao(txtDescicao.getText());
            motivoAgenda.setObservacoes(txtObservacoes.getText());
            motivoAgenda.setAtivo(chkAtivo.isSelected());
    ...
    private void initComponents() {
        ...
        setTitle("Cadastro de Motivo de Agenda");
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        ...
        Util.salvar(motivoAgenda, this, true);
