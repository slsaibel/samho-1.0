 ...
 *
 * @version  revision 001.20170422 date 22/04/2017 author Saibel, Sérgio Luis reason
 ...
 * 
 */
public final class IFrmManSintomaApresentado extends JInternalFrame {

    // Declaração de atributos
    private SintomasApresentados sintomaApresentado;

    // Construtor
    public IFrmManSintomaApresentado(SintomasApresentados sintomaApresentado) throws Exception {
        initComponents();
        ...
        carregarObjetoIFrmManutencao(sintomaApresentado);
    }

    public void carregarObjetoIFrmManutencao(SintomasApresentados sintomaApresentado) {
        try {
            if (sintomaApresentado.getIdSintomaApresentado()!= -1) {
                txtCodigo.setText(String.valueOf(
                        sintomaApresentado.getIdSintomaApresentado()));
            } else {
                txtCodigo.setText(String.valueOf(
                        sintomaApresentado.getSintomaApresentadoDAO().getProximoID()));
            }
            
            txtDescicao.setText(sintomaApresentado.getDescricao());
            txtObservacoes.setText(sintomaApresentado.getObservacoes());
            chkAtivo.setSelected(sintomaApresentado.isAtivo());
        } catch (Exception ex) {
    ...
    private void reescreverObjeto() {
        try {
            sintomaApresentado.setIdSintomaApresentado(Long.parseUnsignedLong(
                    txtCodigo.getText()));
            sintomaApresentado.setDescricao(txtDescicao.getText());
            sintomaApresentado.setObservacoes(txtObservacoes.getText());
            sintomaApresentado.setAtivo(chkAtivo.isSelected());
    ...
    private void initComponents() {
        ...
        setTitle("Cadastro de Sintoma Apresentado");
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        ...
        Util.salvar(sintomaApresentado, this, true);
