 ...
 * 
 */
public final class IFrmManEspecializacao extends JInternalFrame {

    // Declaração de atributos
    private Especializacoes especializacao;

    // Construtor
    public IFrmManEspecializacao(Especializacoes especializacao) throws Exception {
        initComponents();
        ...
        carregarObjetoIFrmManutencao(especializacao);
    }

    public void carregarObjetoIFrmManutencao(Especializacoes especializacao) {
        try {
            if (especializacao.getIdEspecializacao()!= -1) {
                txtCodigo.setText(String.valueOf(
                        especializacao.getIdEspecializacao()));
            } else {
                txtCodigo.setText(String.valueOf(
                        especializacao.getEspecializacaoDAO().getProximoID()));
            }
            txtDescicao.setText(especializacao.getDescricao());
            txtObservacoes.setText(especializacao.getObservacoes());
        } catch (Exception ex) {
    ...
    private void reescreverObjeto() {
        try {
            especializacao.setIdEspecializacao(Long.parseUnsignedLong(
                    txtCodigo.getText()));
            especializacao.setDescricao(txtDescicao.getText());
            especializacao.setObservacoes(txtObservacoes.getText());
    ...
    private void initComponents() {
        ...
        txtObservacoes.setPreferredSize(new java.awt.Dimension(164, 94));
        jScrollPane1.setViewportView(txtObservacoes);

        pnlGeral.add(jScrollPane1);
        jScrollPane1.setBounds(172, 63, 486, 129);
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        ...
        Util.salvar(especializacao, this, true);
