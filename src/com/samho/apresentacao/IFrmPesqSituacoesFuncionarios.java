 ...
 * 
 */
public class IFrmPesqSituacoesFuncionarios extends JInternalFrame {

    // Declaração de atributos
    private IFrmManSituacaoFuncionarios iFrmManSituacao;
    private SituacoesFuncionarios situacao;
    private JTextField jTextFieldCodigo;
    private JTextField jTextFieldDescricao;
    private ArrayList<DadosDAO> dadosWhere;

    // Construtor
    public IFrmPesqSituacoesFuncionarios(IFrmManSituacaoFuncionarios iFrmManSituacao) throws Exception {
        inicializar(iFrmManSituacao);
    }

    public IFrmPesqSituacoesFuncionarios(IFrmManSituacaoFuncionarios iFrmManSituacao,
    ...
    private void inicializar(IFrmManSituacaoFuncionarios iFrmManSituacao) {
        initComponents();

        tbResultado.getTableHeader().setReorderingAllowed(false);
        this.iFrmManSituacao = iFrmManSituacao;
        situacao = iFrmManSituacao.getSituacao();
        dadosWhere = new ArrayList<>();
        dadosWhere.addAll(situacao.getObjetoDAO().getCondicaoWhere());

        Util.atualizar(situacao, tbResultado);
    ...
    public void verificarPermissoes (){
        boolean[] acoes = Util.getAcoesUsuario(Principal.SITUACOES_FUNCIONARIOS);
    ...
    private void reescreverObjeto() {
        try {
            situacao.setIdSituacao(Long.parseUnsignedLong(
                    tbResultado.getValueAt(
                            tbResultado.getSelectedRow(), 0).toString()));
            situacao.setDescricao(tbResultado.getValueAt(
                    tbResultado.getSelectedRow(), 1).toString());
            situacao.setObservacoes(tbResultado.getValueAt(
    ...
    private void efetuarPesquisa() {
        situacao.removerWhere();

        if (!txtCodigo.getText().equals("")) {
            Util.verificarPesquisarCampoID(situacao, txtCodigo);
        }

        if (!txtDescricao.getText().equals("")) {
            Util.verificarPesquisarCampoDescricao(situacao, txtDescricao);
        }
        
        if (chkAtivo.isSelected()) {
            Util.verificarPesquisarObjetoAtivo(situacao, chkAtivo);
        }

        situacao.adicionarWhere(dadosWhere);
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setTitle("Consultar Situações de Funcionários");
    ...
    private void btnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIncluirActionPerformed
        try {
            iFrmManSituacao.carregarObjetoIFrmManutencao(new SituacoesFuncionarios());

            Util.incluir(this, iFrmManSituacao);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this.getParent(),
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        try {
            reescreverObjeto();
            iFrmManSituacao.carregarObjetoIFrmManutencao(situacao);

            Util.alterar(this, iFrmManSituacao);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this.getParent(),
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        Util.excluir(situacao, tbResultado, this);
    ...
    private void tbResultadoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbResultadoMouseClicked
        if ((btnAlterar.isEnabled()) && (evt.getClickCount() == 2)) {          try {
                ...
                if ((jTextFieldCodigo == null) && (jTextFieldDescricao == null)) {
                    ...
                    jTextFieldCodigo.setText(String.valueOf(situacao.getIdSituacao()));
                    jTextFieldDescricao.setText(situacao.getDescricao());
     ...
     * @return the situacao
     */
    public SituacoesFuncionarios getSituacao() {
        return situacao;
    }
     ...
     */
    public void setSituacao(SituacoesFuncionarios situacao) {
