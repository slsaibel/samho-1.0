 ...
 */
public class IFrmPesqPessoasEspecializacoes extends JInternalFrame {

    // Declaração de atributos
    private IFrmManPessoaEspecializacao iFrmManPessoaEspecializacao;
    ...
    // Construtor
    public IFrmPesqPessoasEspecializacoes(
            IFrmManPessoaEspecializacao iFrmManPessoaEspecializacao)throws Exception {
        inicializar(iFrmManPessoaEspecializacao);
    }
    ...
    private void inicializar(
        ...
        this.iFrmManPessoaEspecializacao = iFrmManPessoaEspecializacao;
        pessoaEspecializacao = 
                iFrmManPessoaEspecializacao.getPessoaEspecializacao();
        dadosWhere = new ArrayList<>();
        dadosWhere.addAll(pessoaEspecializacao.getObjetoDAO().getCondicaoWhere());

        Util.atualizar(pessoaEspecializacao, tbResultado);
    ...
    public void verificarPermissoes (){
        boolean[] acoes = Util.getAcoesUsuario(Principal.PESSOAS_ESPECIALIZACOES);
    ...
    private void reescreverObjeto() {
        try {
            ...
            // Reserva-se a próxima posição para a descrição do campo acima.
            pessoaEspecializacao.setInstituicao(tbResultado.getValueAt(
            ...
            pessoaEspecializacao.setObservacoes(tbResultado.getValueAt(
    ...
    private void efetuarPesquisa() {
        pessoaEspecializacao.removerWhere();

        if (!txtCodigo.getText().equals("")) {
            Util.verificarPesquisarCampoID(pessoaEspecializacao, txtCodigo);
        }

        if (!txtDescricao.getText().equals("")) {
            Util.verificarPesquisarCampoDescricao(pessoaEspecializacao, 
                    txtDescricao);
        }

        pessoaEspecializacao.adicionarWhere(dadosWhere);
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setTitle("Consultar Especializações de Pessoas");
        ...
        pnlMenuBotoesLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlMenuBotoesLayout.createSequentialGroup()
        ...
        jLabel1.setText("Cód. Pessoa Esp.");
    ...
    private void btnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIncluirActionPerformed
        try {
            iFrmManPessoaEspecializacao.carregarObjetoIFrmManutencao(
                    new PessoasEspecializacoes());

            Util.incluir(this, iFrmManPessoaEspecializacao);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this.getParent(),
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        try {
            ...
            JOptionPane.showMessageDialog(this.getParent(),
                    Util.alterar(this, iFrmManPessoaEspecializacao));
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        Util.excluir(pessoaEspecializacao, tbResultado, this);
        ...
        if ((btnAlterar.isEnabled()) && (evt.getClickCount() == 2)) {
            try {
                ...
                if ((jTextFieldCodigo != null) && (jTextFieldDescricao != null)) {
                    ...
                    registrador = pessoaEspecializacao.getObjetoDAO().popularCodigoDescricao(
                            String.valueOf(pessoaEspecializacao.getIdPessoaEspecializacao()),
                            pessoaEspecializacao.getPessoaEspecializacaoDAO().getSQLSubstiturCampoDescricao(
