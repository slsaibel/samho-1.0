 ...
 * 
 */
public class IFrmPesqProfissionais extends JInternalFrame {

    // Declaração de atributos
    private IFrmManProfissional iFrmManProfissional;
    ...
    // Construtor
    public IFrmPesqProfissionais(IFrmManProfissional iFrmManProfissional)
            throws Exception {
        inicializar(iFrmManProfissional);
    }
    ...
    private void inicializar(IFrmManProfissional iFrmManProfissional) {
        initComponents();

        tbResultado.getTableHeader().setReorderingAllowed(false);
        this.iFrmManProfissional = iFrmManProfissional;
        profissional = iFrmManProfissional.getProfissional();
        dadosWhere = new ArrayList<>();
        dadosWhere.addAll(profissional.getObjetoDAO().getCondicaoWhere());

        Util.atualizar(profissional, tbResultado);
    ...
    private void efetuarPesquisa() {
        profissional.removerWhere();

        if (!txtCodigo.getText().equals("")) {
            Util.verificarPesquisarCampoID(profissional, txtCodigo);
        }

        if (!txtDescricao.getText().equals("")) {
            Util.verificarPesquisarCampoDescricao(profissional, txtDescricao);
        }
        
        if (chkAtivo.isSelected()) {
            Util.verificarPesquisarObjetoAtivo(profissional, chkAtivo);
        }

        profissional.adicionarWhere(dadosWhere);
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setTitle("Consultar Profissionais");
        ...
        getAccessibleContext().setAccessibleName("Consultar Profissionais");
    ...
    private void btnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIncluirActionPerformed
        try {
            iFrmManProfissional.carregarObjetoIFrmManutencao(new Profissionais());

            Util.incluir(this, iFrmManProfissional);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this.getParent(),
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        try {
            reescreverObjeto();
            iFrmManProfissional.carregarObjetoIFrmManutencao(profissional);

            Util.alterar(this, iFrmManProfissional);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this.getParent(),
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        Util.excluir(profissional, tbResultado, this);
            ...
            try {
                ...
                if ((jTextFieldCodigo != null) && (jTextFieldDescricao != null)) {
                    ...
                    registrador = profissional.getObjetoDAO().popularCodigoDescricao(
                            String.valueOf(profissional.getIdProfissional()),
