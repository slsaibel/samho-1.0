 ...
 */
public class IFrmPesqFuncionarios extends JInternalFrame {

    // Declaração de atributos
    private IFrmManFuncionario iFrmManFuncionario;
    ...
    // Construtor
    public IFrmPesqFuncionarios(IFrmManFuncionario iFrmManFuncionario)
            throws Exception {
        inicializar(iFrmManFuncionario);
    }
    ...
    private void inicializar(IFrmManFuncionario iFrmManFuncionario) {
        initComponents();

        tbResultado.getTableHeader().setReorderingAllowed(false);
        this.iFrmManFuncionario = iFrmManFuncionario;
        funcionario = iFrmManFuncionario.getFuncionario();
        dadosWhere = new ArrayList<>();
        dadosWhere.addAll(funcionario.getObjetoDAO().getCondicaoWhere());

        Util.atualizar(funcionario, tbResultado);
    ...
    private void reescreverObjeto() {
        try {
            ...
            funcionario.setCodSituacao(Long.parseUnsignedLong(
                    tbResultado.getValueAt(
            ...
            // Reserva-se a próxima posição para a descrição do campo acima.
            funcionario.setVlrSalario(Double.parseDouble(tbResultado.getValueAt(
                    tbResultado.getSelectedRow(), 7).toString()));
            funcionario.setDiasTrabalhadosMes(Integer.parseInt(
                    tbResultado.getValueAt(
                            tbResultado.getSelectedRow(), 8).toString()));
            funcionario.setCargaHoraria(Double.parseDouble(
                    tbResultado.getValueAt(
            ...
            funcionario.setDataAdmissao(
                    Formatacao.ajustaData(tbResultado.getValueAt(
                            ...
                            Formatacao.DATA_AMD));
            /** 
             * Verifica: se o valor do campo é "null" então seta a propriedade 
             * como null, senão fomata o campo para dd/MM/yyyy.
             */
            if (tbResultado.getValueAt(
                    tbResultado.getSelectedRow(), 11) == null) {
            ...
            funcionario.setNumeroCLT(Integer.parseInt(tbResultado.getValueAt(
                    tbResultado.getSelectedRow(), 12).toString()));
    ...
    private void efetuarPesquisa() {
        funcionario.removerWhere();

        if (!txtCodigo.getText().equals("")) {
            Util.verificarPesquisarCampoID(funcionario, txtCodigo);
        }

        if (!txtDescricao.getText().equals("")) {
            Util.verificarPesquisarCampoDescricao(funcionario, txtDescricao);
        }

        funcionario.adicionarWhere(dadosWhere);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cód. Funcionáriio");
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(pnlBotoes, javax.swing.GroupLayout.DEFAULT_SIZE, 726, Short.MAX_VALUE)
        );
    ...
    private void btnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIncluirActionPerformed
        try {
            iFrmManFuncionario.carregarObjetoIFrmManutencao(new Funcionarios());

            Util.incluir(this, iFrmManFuncionario);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this.getParent(),
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        try {
            reescreverObjeto();
            iFrmManFuncionario.carregarObjetoIFrmManutencao(funcionario);

            JOptionPane.showMessageDialog(this.getParent(),
                    Util.alterar(this, iFrmManFuncionario));
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        Util.excluir(funcionario, tbResultado, this);
        ...
        if ((btnAlterar.isEnabled()) && (evt.getClickCount() == 2)) {
            try {
                ...
                if ((jTextFieldCodigo != null) && (jTextFieldDescricao != null)) {
                    ...
                    registrador = funcionario.getObjetoDAO().popularCodigoDescricao(
                            String.valueOf(funcionario.getIdFuncionario()),
                            funcionario.getFuncionarioDAO().getSQLSubstiturCampoDescricao(
