 ...
 */
public class IFrmPesqGlossarioDoencasMedicamentos extends JInternalFrame {

    // Declaração de atributos
    private IFrmManGlossarioDoencaMedicamento iFrmManGlossarioDoencaMedicamento;
    ...
    // Construtor
    public IFrmPesqGlossarioDoencasMedicamentos(
            IFrmManGlossarioDoencaMedicamento iFrmManGlossarioDoencaMedicamento)
            throws Exception {
        inicializar(iFrmManGlossarioDoencaMedicamento);
    }
    ...
    private void inicializar(
        ...
        this.iFrmManGlossarioDoencaMedicamento = iFrmManGlossarioDoencaMedicamento;
        glossarioDoencaMedicamento = 
                iFrmManGlossarioDoencaMedicamento.getGlossarioDoencaMedicamento();
        dadosWhere = new ArrayList<>();
        dadosWhere.addAll(glossarioDoencaMedicamento.getObjetoDAO().getCondicaoWhere());

        Util.atualizar(glossarioDoencaMedicamento, tbResultado);
    ...
    public void verificarPermissoes (){
        boolean[] acoes = Util.getAcoesUsuario(
                Principal.GLOSSARIO_DOENCA_MEDICAMENTOS);
    ...
    private void reescreverObjeto() {
        try {
            ...
            glossarioDoencaMedicamento.setParecerProfissional(tbResultado.getValueAt(
    ...
    private void efetuarPesquisa() {
        glossarioDoencaMedicamento.removerWhere();

        if (!txtCodigo.getText().equals("")) {
            Util.verificarPesquisarCampoID(glossarioDoencaMedicamento, txtCodigo);
        }

        if (!txtDescricao.getText().equals("")) {
            Util.verificarPesquisarCampoDescricao(glossarioDoencaMedicamento, 
                    txtDescricao);
        }
        
        glossarioDoencaMedicamento.adicionarWhere(dadosWhere);
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setTitle("Consultar Glossários Medicamentos");
        setToolTipText("");
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(pnlBotoes, javax.swing.GroupLayout.DEFAULT_SIZE, 729, Short.MAX_VALUE)
        );
    ...
    private void btnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIncluirActionPerformed
        try {
            iFrmManGlossarioDoencaMedicamento.carregarObjetoIFrmManutencao(
                    new GlossarioDoencasMedicamentos());

            Util.incluir(this, iFrmManGlossarioDoencaMedicamento);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this.getParent(),
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        try {
            ...
            JOptionPane.showMessageDialog(this.getParent(),
                    Util.alterar(this, iFrmManGlossarioDoencaMedicamento));
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        Util.excluir(glossarioDoencaMedicamento, tbResultado, this);
        ...
        if ((btnAlterar.isEnabled()) && (evt.getClickCount() == 2)) {
            try {
                ...
                if ((jTextFieldCodigo != null) && (jTextFieldDescricao != null)) {
                    ...
                    registrador = glossarioDoencaMedicamento.getObjetoDAO().popularCodigoDescricao(
                            String.valueOf(glossarioDoencaMedicamento.getIdGlossarioDoencasMedicamento()),
                            glossarioDoencaMedicamento.getGlossarioDoencaMedicamentoDAO().getSQLSubstiturCampoDescricao(
